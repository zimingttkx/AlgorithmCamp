...
> 来源：[灵茶山艾府题单](https://leetcode.cn/circle/discuss/K0n2gO/)
...
| LCR 029 | [循环有序列表的插入](https://leetcode.cn/problems/lcr-029/) | — |
...
| LCP 44 | [开幕式焰火](https://leetcode.cn/problems/lcp-44/) | — |
...
| 508 | [出现次数最多的子树元素和 不使用外部变量](https://leetcode.cn/problems/most-frequent-subtree-sum/) | — |
...
| 1026 | [节点与其祖先之间的最大差值 多种做法](https://leetcode.cn/problems/maximum-difference-between-node-and-ancestor/) | — |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| LCP 67 | [装饰树](https://leetcode.cn/problems/lcp-67/) | — |
| 298 | [二叉树最长连续序列 🔒](https://leetcode.cn/problems/binary-tree-longest-consecutive-sequence/) | — |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 538 | [把二叉搜索树转换为累加树](https://leetcode.cn/problems/convert-bst-to-greater-tree/) | 1375 |
| 1038 | [从二叉搜索树到更大和树](https://leetcode.cn/problems/binary-search-tree-to-greater-sum-tree/) | — |
| 865 | [具有所有最深节点的最小子树  也可以自底向上](https://leetcode.cn/problems/smallest-subtree-with-all-the-deepest-nodes/) | 1534 |
...
| 98 | [验证二叉搜索树 有前序、中序和后序三种做法](https://leetcode.cn/problems/validate-binary-search-tree/) | — |
...
| 199 | [二叉树的右视图 也可以 DFS](https://leetcode.cn/problems/binary-tree-right-side-view/) | — |
...
| 979 | [在二叉树中分配硬币  贡献法](https://leetcode.cn/problems/distribute-coins-in-binary-tree/) | 1709 |
...
| 2458 | [移除子树后的二叉树高度  推荐](https://leetcode.cn/problems/height-of-binary-tree-after-subtree-removal-queries/) | 2299 |
| LCP 26 | [导航装置](https://leetcode.cn/problems/lcp-26/) | — |
| LCP 60 | [力扣泡泡龙](https://leetcode.cn/problems/lcp-60/) | — |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 3593 | [使叶子路径成本相等的最小增量  也可以自底向上](https://leetcode.cn/problems/minimum-increments-to-equalize-leaf-paths/) | 1959 |
...
| 3590 | [第 K 小的路径异或和  做法不止一种](https://leetcode.cn/problems/kth-smallest-path-xor-sum/) | 2646 |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 1483 | [树节点的第 K 个祖先  模板题](https://leetcode.cn/problems/kth-ancestor-of-a-tree-node/) | 2115 |
| 3559 | [给边赋权值的方案数 II](https://leetcode.cn/problems/number-of-ways-to-assign-edge-weights-ii/) | 2146 |
| 3553 | [包含给定路径的最小带权子树 II  结论](https://leetcode.cn/problems/minimum-weighted-subgraph-with-the-required-paths-ii/) | 2411 |
...
| 2646 | [最小化旅行的价格总和 树上差分](https://leetcode.cn/problems/minimize-the-total-price-of-the-trips/) | — |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 3786 | [树组的交互代价总和 与 20 无关的做法](https://leetcode.cn/problems/total-sum-of-interaction-cost-in-tree-groups/) | — |

### §3.10 树上启发式合并
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 2003 | [每棵子树内缺失的最小基因值](https://leetcode.cn/problems/smallest-missing-genetic-value-in-each-subtree/) | 2415 |
| 3590 | [第 K 小的路径异或和  C++ 需要用 pbds](https://leetcode.cn/problems/kth-smallest-path-xor-sum/) | 2646 |
...
| LCP 51 | [烹饪料理](https://leetcode.cn/problems/lcp-51/) | — |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 39 | [组合总和 同一个数可以重复选](https://leetcode.cn/problems/combination-sum/) | — |
...
| 1415 | [长度为 n 的开心字符串中字典序第 k 小的字符串  也有 O(n) 的做法](https://leetcode.cn/problems/the-k-th-lexicographical-string-of-all-happy-strings-of-length-n/) | 1576 |
...
| 473 | [火柴拼正方形 子集分割问题，k=4](https://leetcode.cn/problems/matchsticks-to-square/) | — |
...
| 面试题 17.25 | [单词矩阵](https://leetcode.cn/problems/面试题-17.25/) | — |
...
| 215 | [数组中的第K个最大元素 先做这题再做 912 题](https://leetcode.cn/problems/kth-largest-element-in-an-array/) | — |
| 912 | [排序数组 手写快排](https://leetcode.cn/problems/sort-an-array/) | — |
