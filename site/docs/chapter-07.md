...
> 来源：[灵茶山艾府题单](https://leetcode.cn/circle/discuss/tXLS3i/)
...
| 746 | [使用最小花费爬楼梯](https://leetcode.cn/problems/min-cost-climbing-stairs/) | 1500 |
| 3693 | [爬楼梯 II](https://leetcode.cn/problems/climbing-stairs-ii/) | 1560 |
| 377 | [组合总和 Ⅳ](https://leetcode.cn/problems/combination-sum-iv/) | 1600 |
...
| 2533 | [好二进制字符串的数量同  题 🔒](https://leetcode.cn/problems/number-of-good-binary-strings/) | 2466 |
...
| 3363 | [最多可收集的水果数目](https://leetcode.cn/problems/find-the-maximum-number-of-fruits-collected/) | 2200 |
| 1463 | [摘樱桃 II](https://leetcode.cn/problems/cherry-pickup-ii/) | — |
| 741 | [摘樱桃](https://leetcode.cn/problems/cherry-pickup/) | — |
| 3459 | [最长 V 形对角线段的长度](https://leetcode.cn/problems/length-of-longest-v-shaped-diagonal-segment/) | 2337 |
...
| 2742 | [给墙壁刷油漆  至少装满](https://leetcode.cn/problems/painting-the-walls/) | 2425 |
| 3287 | [求出数组中最大序列值](https://leetcode.cn/problems/find-the-maximum-sequence-value-of-array/) | 2545 |
| 3181 | [执行操作可获得的最大总奖励 II  bitset](https://leetcode.cn/problems/maximum-total-reward-using-operations-ii/) | 2688 |
| LCP 47 | [入场安检](https://leetcode.cn/problems/lcp-47/) | — |
...
| 3647 | [两个袋子中的最大重量多背包 🔒](https://leetcode.cn/problems/maximum-weight-in-two-bags/) | — |
...
| 3183 | [达到总和的方法数量混合背包 🔒](https://leetcode.cn/problems/the-number-of-ways-to-make-the-sum/) | — |
...
| 1458 | [两个子序列的最大点积  如何表达「子序列非空」](https://leetcode.cn/problems/max-dot-product-of-two-subsequences/) | 1824 |
...
| 2111 | [使数组 K 递增的最少操作次数  包含进阶问题](https://leetcode.cn/problems/minimum-operations-to-make-the-array-k-increasing/) | 1941 |
...
| 1713 | [得到子序列的最少操作次数  用 LIS 求 LCS](https://leetcode.cn/problems/minimum-operations-to-make-a-subsequence/) | 2351 |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 368 | [最大整除子集](https://leetcode.cn/problems/largest-divisible-subset/) | 1800 |
...
| 3196 | [最大化子数组的总成本  也有状态机 DP 做法](https://leetcode.cn/problems/maximize-total-cost-of-alternating-subarrays/) | 1847 |
...
| LCR 165 | [解密数字](https://leetcode.cn/problems/lcr-165/) | — |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 3500 | [将数组分割为子数组的最小代价](https://leetcode.cn/problems/minimum-cost-to-divide-array-into-subarrays/) | 2569 |
...
| 3599 | [划分数组得到最小 XOR  做法不止一种](https://leetcode.cn/problems/partition-array-to-minimize-xor/) | 1955 |
...
| 3473 | [长度至少为 M 的 K 个子数组之和](https://leetcode.cn/problems/sum-of-k-subarrays-with-length-at-least-m/) | 2274 |
...
| 3538 | [合并得到最小旅行时间  相邻相关](https://leetcode.cn/problems/merge-operations-for-minimum-travel-time/) | 2461 |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 121 | [买卖股票的最佳时机 交易 1 次](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock/) | — |
| 122 | [买卖股票的最佳时机 II 交易次数不限](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-ii/) | — |
| 123 | [买卖股票的最佳时机 III 交易 2 次](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-iii/) | — |
| 188 | [买卖股票的最佳时机 IV 交易 k 次](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-iv/) | — |
| 3573 | [买卖股票的最佳时机 V 交易 k 次](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-v/) | 1777 |
| 309 | [买卖股票的最佳时机含冷冻期 交易次数不限](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-with-cooldown/) | — |
| 714 | [买卖股票的最佳时机含手续费 交易次数不限](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-with-transaction-fee/) | — |
...
| 3196 | [最大化子数组的总成本  也有划分型 DP 做法](https://leetcode.cn/problems/maximize-total-cost-of-alternating-subarrays/) | 1847 |
| 935 | [骑士拨号器](https://leetcode.cn/problems/knight-dialer/) | — |
| 1537 | [最大得分](https://leetcode.cn/problems/get-the-maximum-score/) | 1961 |
| 3811 | [交替按位异或分割的数目  做法不止一种](https://leetcode.cn/problems/number-of-alternating-xor-partitions/) | 2006 |
...
| 3743 | [循环划分的最大得分](https://leetcode.cn/problems/maximize-cyclic-partition-score/) | 3125 |
| LCP 19 | [秋叶收藏集](https://leetcode.cn/problems/lcp-19/) | — |
...
| 2140 | [解决智力问题  可以用刷表法](https://leetcode.cn/problems/solving-questions-with-brainpower/) | 1709 |
| 983 | [最低票价  有 O(n) 做法](https://leetcode.cn/problems/minimum-cost-for-tickets/) | 1786 |
| 368 | [最大整除子集](https://leetcode.cn/problems/largest-divisible-subset/) | 1800 |
| 2901 | [最长相邻不相等子序列 II](https://leetcode.cn/problems/longest-unequal-adjacent-groups-subsequence-ii/) | 1899 |
| 650 | [两个键的键盘](https://leetcode.cn/problems/2-keys-keyboard/) | 2000 |
...
| 3205 | [最大数组跳跃得分 I有 O(n) 做法 🔒](https://leetcode.cn/problems/maximum-array-hopping-score-i/) | — |
| 1259 | [不相交的握手 🔒](https://leetcode.cn/problems/handshakes-that-dont-cross/) | — |
| 2597 | [美丽子集的数目 用 DP 解决](https://leetcode.cn/problems/the-number-of-beautiful-subsets/) | — |
| 2638 | [统计 K-Free 子集的总数上面这题的加强版 🔒](https://leetcode.cn/problems/count-the-number-of-k-free-subsets/) | — |
...
| 1186 | [删除一次得到子数组最大和](https://leetcode.cn/problems/maximum-subarray-sum-with-one-deletion/) | 1799 |
| 3738 | [替换至多一个元素后最长非递减子数组](https://leetcode.cn/problems/longest-non-decreasing-subarray-after-replacing-at-most-one-element/) | 1811 |
| 3524 | [求出数组的 X 值 I  刷表法](https://leetcode.cn/problems/find-x-value-of-array-i/) | 2008 |
| 3448 | [统计可以被最后一个数位整除的子字符串数目  刷表法](https://leetcode.cn/problems/count-substrings-divisible-by-last-digit/) | 2387 |
...
| 2826 | [将三个组排序  做法不止一种](https://leetcode.cn/problems/sorting-three-groups/) | 1721 |
...
| 446 | [等差数列划分 II - 子序列 求个数](https://leetcode.cn/problems/arithmetic-slices-ii-subsequence/) | — |
| 3811 | [交替按位异或分割的数目  做法不止一种](https://leetcode.cn/problems/number-of-alternating-xor-partitions/) | 2006 |
| 3351 | [好子序列的元素之和  求和](https://leetcode.cn/problems/sum-of-good-subsequences/) | 2086 |
| 3041 | [修改数组后最大化数组中的连续元素数目](https://leetcode.cn/problems/maximize-consecutive-elements-in-an-array-after-modification/) | 2231 |
| 3409 | [最长相邻绝对差递减子序列](https://leetcode.cn/problems/longest-subsequence-with-decreasing-adjacent-difference/) | 2500 |
...
| 1987 | [不同的好子序列数目  思考方式同 940 题](https://leetcode.cn/problems/number-of-unique-good-subsequences/) | 2422 |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 2222 | [选择建筑的方案数  把 3 改成 k 怎么做？](https://leetcode.cn/problems/number-of-ways-to-select-buildings/) | 1657 |
| 2826 | [将三个组排序  做法不止一种](https://leetcode.cn/problems/sorting-three-groups/) | 1721 |
...
| 3780 | [能被 3 整除的三元组最大和 通用做法](https://leetcode.cn/problems/maximum-sum-of-three-numbers-divisible-by-three/) | — |
...
| 3218 | [切蛋糕的最小总开销 I 也有贪心做法](https://leetcode.cn/problems/minimum-cost-for-cutting-cake-i/) | — |
...
| 1320 | [二指输入的的最小距离  状态优化](https://leetcode.cn/problems/minimum-distance-to-type-a-word-using-two-fingers/) | 2028 |
...
| 3469 | [移除所有数组元素的最小代价](https://leetcode.cn/problems/find-minimum-cost-to-remove-array-elements/) | 2112 |
...
| 1883 | [准时抵达会议现场的最小跳过休息次数  避免浮点运算的技巧](https://leetcode.cn/problems/minimum-skips-to-arrive-at-meeting-on-time/) | 2588 |
...
| 3003 | [执行操作后的最大分割数量  如何分析时间复杂度](https://leetcode.cn/problems/maximize-the-number-of-partitions-after-operations/) | 3039 |
| 3225 | [网格图操作后的最大分数  IOI2022 原题](https://leetcode.cn/problems/maximum-score-from-grid-operations/) | 3028 |
| LCP 57 | [打地鼠](https://leetcode.cn/problems/lcp-57/) | — |
| LCP 43 | [十字路口的交通](https://leetcode.cn/problems/lcp-43/) | — |
| LCP 65 | [舒适的湿度](https://leetcode.cn/problems/lcp-65/) | — |
| LCP 36 | [最多牌组数](https://leetcode.cn/problems/lcp-36/) | — |
| LCP 38 | [守卫城堡](https://leetcode.cn/problems/lcp-38/) | — |
...
| 面试题 08.14 | [布尔运算](https://leetcode.cn/problems/面试题-08.14/) | — |
...
| 546 | [移除盒子 同 CF1107E](https://leetcode.cn/problems/remove-boxes/) | — |
...
| 3533 | [判断连接可整除性  字典序 暴搜](https://leetcode.cn/problems/concatenated-divisibility/) | 2257 |
| 3530 | [有向无环图中合法拓扑排序的最大利润  拓扑序](https://leetcode.cn/problems/maximum-profit-from-valid-topological-order-in-dag/) | 2353 |
...
| 2403 | [杀死所有怪物的最短时间同  题 🔒](https://leetcode.cn/problems/minimum-time-to-kill-all-monsters/) | 3376 |
...
| 1681 | [最小不兼容性  有 O(n](https://leetcode.cn/problems/minimum-incompatibility/) | 2390 |
...
| LCP 04 | [覆盖](https://leetcode.cn/problems/lcp-04/) | — |
| LCP 53 | [守护太空城](https://leetcode.cn/problems/lcp-53/) | — |
...
| 3276 | [选择矩阵中单元格的最大得分  横看成岭侧成峰](https://leetcode.cn/problems/select-cells-in-grid-with-maximum-score/) | 2403 |
...
| 357 | [统计各位数字都不同的数字个数 同  题](https://leetcode.cn/problems/count-numbers-with-unique-digits/) | 2376 |
...
| 3519 | [统计逐位非递减的整数  进制转换](https://leetcode.cn/problems/count-numbers-with-non-decreasing-digits/) | 2246 |
...
| 3621 | [位计数深度为 K 的整数数目 I 同  题](https://leetcode.cn/problems/number-of-integers-with-popcount-depth-equal-to-k-i/) | 3352 |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 3704 | [统计和为 N 的无零数对  数对](https://leetcode.cn/problems/count-no-zero-pairs-that-sum-to-n/) | 2419 |
...
| 面试题 17.06 | [2 出现的次数](https://leetcode.cn/problems/面试题-17.06/) | — |
| 3007 | [价值和小于等于 K 的最大数字  做法不止一种](https://leetcode.cn/problems/maximum-number-that-sum-of-the-prices-is-less-than-or-equal-to-k/) | 2258 |
...
| 3348 | [最小可整除数位乘积 II  只有下界](https://leetcode.cn/problems/smallest-divisible-digit-product-ii/) | 3101 |
...
| 3193 | [统计逆序对的数目](https://leetcode.cn/problems/count-the-number-of-inversions/) | 2266 |
| 3473 | [长度至少为 M 的 K 个子数组之和  划分型](https://leetcode.cn/problems/sum-of-k-subarrays-with-length-at-least-m/) | 2274 |
| 3251 | [单调数组对的数目 II  也有组合数学做法](https://leetcode.cn/problems/find-the-count-of-monotonic-pairs-ii/) | 2323 |
| 2478 | [完美分割的方案数](https://leetcode.cn/problems/number-of-beautiful-partitions/) | 2344 |
...
| 3077 | [K 个不相交子数组的最大能量值  划分型](https://leetcode.cn/problems/maximum-strength-of-k-disjoint-subarrays/) | 2557 |
| 3333 | [找到初始输入字符串 II  也有生成函数做法](https://leetcode.cn/problems/find-the-original-typed-string-ii/) | 2629 |
| 2902 | [和带限制的子多重集合的数目](https://leetcode.cn/problems/count-of-sub-multisets-with-bounded-sum/) | 2759 |
| 1977 | [划分数字的方案数](https://leetcode.cn/problems/number-of-ways-to-separate-numbers/) | 2817 |
| 3130 | [找出所有稳定的二进制数组 II  也有组合数学做法](https://leetcode.cn/problems/find-all-possible-stable-binary-arrays-ii/) | 2825 |
...
| 2916 | [子数组不同元素数目的平方和 II  思路类似  题](https://leetcode.cn/problems/subarrays-distinct-element-sum-of-squares-ii/) | 2816 |
...
| 3693 | [爬楼梯 II 与 K=3 无关的做法](https://leetcode.cn/problems/climbing-stairs-ii/) | — |
...
| 2318 | [不同骰子序列的数目 容斥优化（类似 CF1943D2）](https://leetcode.cn/problems/number-of-distinct-roll-sequences/) | — |
| 3181 | [执行操作可获得的最大总奖励 II  bitset](https://leetcode.cn/problems/maximum-total-reward-using-operations-ii/) | 2688 |
| 2267 | [检查是否有合法括号字符串路径 可以进一步地用 bitset](https://leetcode.cn/problems/check-if-there-is-a-valid-parentheses-string-path/) | — |
| 3213 | [最小代价构造字符串 字符串哈希 / 后缀数组 / AC 自动机优化](https://leetcode.cn/problems/construct-string-with-minimum-cost/) | — |
| 3292 | [形成目标字符串需要的最少字符串数 II 字符串哈希 / AC 自动机优化](https://leetcode.cn/problems/minimum-number-of-valid-strings-to-form-target-ii/) | — |
| 3743 | [循环划分的最大得分 闵可夫斯基和](https://leetcode.cn/problems/maximize-cyclic-partition-score/) | — |
| LCP 14 | [切分数组](https://leetcode.cn/problems/lcp-14/) | — |
| LCP 59 | [搭桥过河 Slope Trick](https://leetcode.cn/problems/lcp-59/) | — |
| 2263 | [数组变为有序的最小操作次数Slope Trick 🔒](https://leetcode.cn/problems/make-array-non-decreasing-or-non-increasing/) | — |
...
| 3372 | [连接两棵树后最大目标节点数目 I 算法优化](https://leetcode.cn/problems/maximize-the-number-of-target-nodes-after-connecting-trees-i/) | — |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 337 | [打家劫舍 III（没有上司的舞会）](https://leetcode.cn/problems/house-robber-iii/) | — |
| 2646 | [最小化旅行的价格总和](https://leetcode.cn/problems/minimize-the-total-price-of-the-trips/) | 2238 |
| 3544 | [子树反转和  记忆化搜索 / 树上刷表法](https://leetcode.cn/problems/subtree-inversion-sum/) | 2545 |
...
| 3068 | [最大节点价值之和](https://leetcode.cn/problems/find-the-maximum-sum-of-node-values/) | 2268 |
| 2920 | [收集所有金币可获得的最大积分  记忆化搜索](https://leetcode.cn/problems/maximum-points-after-collecting-coins-from-all-nodes/) | 2351 |
| 3575 | [最大好子树分数](https://leetcode.cn/problems/maximum-good-subtree-score/) | 2360 |
| 3562 | [折扣价交易股票的最大利润  背包](https://leetcode.cn/problems/maximum-profit-from-trading-stocks-with-discounts/) | 2458 |
...
| LCP 10 | [二叉树任务调度](https://leetcode.cn/problems/lcp-10/) | — |
| LCP 34 | [二叉树染色](https://leetcode.cn/problems/lcp-34/) | — |
| LCP 64 | [二叉树灯饰](https://leetcode.cn/problems/lcp-64/) | — |
...
| 2050 | [并行课程 III  DAG](https://leetcode.cn/problems/parallel-courses-iii/) | 2084 |
| 3620 | [恢复网络路径 DAG](https://leetcode.cn/problems/network-recovery-pathways/) | — |
| 1976 | [到达目的地的方案数](https://leetcode.cn/problems/number-of-ways-to-arrive-at-destination/) | 2095 |
| 3543 | [K 条边路径的最大边权和  DAG bitset](https://leetcode.cn/problems/maximum-weighted-k-edge-path/) | 2110 |
| 1857 | [有向图中最大颜色值  DAG](https://leetcode.cn/problems/largest-color-value-in-a-directed-graph/) | 2313 |
| 1928 | [规定时间内到达终点的最小花费](https://leetcode.cn/problems/minimum-cost-to-reach-destination-in-time/) | 2413 |
| 913 | [猫和老鼠  拓扑序](https://leetcode.cn/problems/cat-and-mouse/) | 2800 |
| 1728 | [猫和老鼠 II  拓扑序](https://leetcode.cn/problems/cat-and-mouse-ii/) | 2849 |
| LCP 07 | [传递信息](https://leetcode.cn/problems/lcp-07/) | — |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 1025 | [除数博弈  有数学做法](https://leetcode.cn/problems/divisor-game/) | 1435 |
| 877 | [石子游戏  有数学做法](https://leetcode.cn/problems/stone-game/) | 1590 |
...
| 1363 | [形成三的最大倍数  字典序](https://leetcode.cn/problems/largest-multiple-of-three/) | 1823 |
| 1449 | [数位成本和为目标值的最大数字  字典序](https://leetcode.cn/problems/form-largest-integer-with-digits-that-add-up-to-target/) | 1927 |
| 1092 | [最短公共超序列](https://leetcode.cn/problems/shortest-common-supersequence/) | 1977 |
| 943 | [最短超级串](https://leetcode.cn/problems/find-the-shortest-superstring/) | 2186 |
| 1125 | [最小的必要团队](https://leetcode.cn/problems/smallest-sufficient-team/) | 2251 |
| 3533 | [判断连接可整除性  字典序 暴搜](https://leetcode.cn/problems/concatenated-divisibility/) | 2257 |
| 3260 | [找出最大的 N 位 K 回文数  字典序 暴搜](https://leetcode.cn/problems/find-the-largest-palindrome-divisible-by-k/) | 2370 |
| 3149 | [找出分数最低的排列  字典序](https://leetcode.cn/problems/find-the-minimum-cost-array-permutation/) | 2642 |
| 3441 | [变成好标题的最少代价  字典序](https://leetcode.cn/problems/minimum-cost-good-caption/) | 2765 |
| 3348 | [最小可整除数位乘积 II  字典序 暴搜](https://leetcode.cn/problems/smallest-divisible-digit-product-ii/) | 3101 |
| 656 | [金币路径字典序 🔒](https://leetcode.cn/problems/coin-path/) | — |
| 471 | [编码最短长度的字符串 🔒](https://leetcode.cn/problems/encode-string-with-shortest-length/) | — |
...
| 845 | [数组中的最长山脉  也可以分组循环](https://leetcode.cn/problems/longest-mountain-in-array/) | 1437 |
...
| 123 | [买卖股票的最佳时机 III 拆分成两个 121 题](https://leetcode.cn/problems/best-time-to-buy-and-sell-stock-iii/) | — |
...
| 1186 | [删除一次得到子数组最大和](https://leetcode.cn/problems/maximum-subarray-sum-with-one-deletion/) | 1799 |
| 3738 | [替换至多一个元素后最长非递减子数组](https://leetcode.cn/problems/longest-non-decreasing-subarray-after-replacing-at-most-one-element/) | 1811 |
| 42 | [接雨水（讲解）](https://leetcode.cn/problems/trapping-rain-water/) | — |
...
| 2552 | [统计上升四元组  四个数](https://leetcode.cn/problems/count-increasing-quadruplets/) | 2433 |
| 3302 | [字典序最小的合法序列  第  题的进阶版本](https://leetcode.cn/problems/find-the-lexicographically-smallest-valid-sequence/) | 2474 |
...
| LCP 09 | [最小跳跃次数](https://leetcode.cn/problems/lcp-09/) | — |
| LCP 20 | [快速公交](https://leetcode.cn/problems/lcp-20/) | — |
