...
> 来源：[灵茶山艾府题单](https://leetcode.cn/circle/discuss/01LUak/)
...
| 924 | [尽量减少恶意软件的传播  附思考题](https://leetcode.cn/problems/minimize-malware-spread/) | 1869 |
| 2101 | [引爆最多的炸弹](https://leetcode.cn/problems/detonate-the-maximum-bombs/) | 1880 |
| 721 | [账户合并](https://leetcode.cn/problems/accounts-merge/) | — |
| 207 | [课程表 三色标记法判环](https://leetcode.cn/problems/course-schedule/) | — |
...
| 127 | [单词接龙 双向广搜](https://leetcode.cn/problems/word-ladder/) | — |
...
| LCR 114 | [火星词典](https://leetcode.cn/problems/lcr-114/) | — |
| 444 | [序列重建拓扑序是否唯一 🔒](https://leetcode.cn/problems/sequence-reconstruction/) | — |
| 3481 | [应用替换也可以记忆化搜索 🔒](https://leetcode.cn/problems/apply-substitutions/) | — |
...
| 2836 | [在传球游戏中最大化函数值  做法不止一种](https://leetcode.cn/problems/maximize-value-of-function-in-a-ball-passing-game/) | 2769 |
...
| 3341 | [到达最后一个房间的最少时间 I  网格图](https://leetcode.cn/problems/find-minimum-time-to-reach-last-room-i/) | 1721 |
| 3112 | [访问消失节点的最少时间  理解原理](https://leetcode.cn/problems/minimum-time-to-visit-disappearing-nodes/) | 1757 |
...
| 3342 | [到达最后一个房间的最少时间 II  网格图](https://leetcode.cn/problems/find-minimum-time-to-reach-last-room-ii/) | 1862 |
| 1631 | [最小体力消耗路径  网格图 做法不止一种](https://leetcode.cn/problems/path-with-minimum-effort/) | 1948 |
...
| 778 | [水位上升的泳池中游泳  网格图 做法不止一种](https://leetcode.cn/problems/swim-in-rising-water/) | 2097 |
...
| 2045 | [到达目的地的第二短时间  也可以 BFS](https://leetcode.cn/problems/second-minimum-time-to-reach-destination/) | 2202 |
| 3419 | [图的最大边权的最小值  做法不止一种](https://leetcode.cn/problems/minimize-the-maximum-edge-weight-of-graph/) | 2243 |
...
| 2577 | [在网格图中访问一个格子的最少时间  网格图](https://leetcode.cn/problems/minimum-time-to-visit-a-cell-in-a-grid/) | 2382 |
...
| 787 | [K 站中转内最便宜的航班 类似  题](https://leetcode.cn/problems/cheapest-flights-within-k-stops/) | 1928 |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| LCP 35 | [电动车游城市](https://leetcode.cn/problems/lcp-35/) | — |
| 3599 | [划分数组得到最小 XOR 做法不止一种](https://leetcode.cn/problems/partition-array-to-minimize-xor/) | — |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 2642 | [设计可以求最短路径的图类  动态加边](https://leetcode.cn/problems/design-graph-with-shortest-path-calculator/) | 1811 |
...
| LCP 54 | [夺回据点](https://leetcode.cn/problems/lcp-54/) | — |
...
| 题号 | 题目 | 难度分 |
|------|------|--------|
| 1947 | [最大兼容性评分和  一对一](https://leetcode.cn/problems/maximum-compatibility-score-sum/) | 1704 |
| 3376 | [破解锁的最少时间 I  一对一](https://leetcode.cn/problems/minimum-time-to-break-locks-i/) | 1793 |
| 2850 | [将石头分散到网格图的最少移动次数  一对多](https://leetcode.cn/problems/minimum-moves-to-spread-stones-over-grid/) | 2001 |
| 1879 | [两个数组最小的异或值之和  一对一](https://leetcode.cn/problems/minimum-xor-sum-of-two-arrays/) | 2145 |
| 1349 | [参加考试的最大学生数  二分图最大独立集](https://leetcode.cn/problems/maximum-students-taking-exam/) | 2386 |
| 2172 | [数组的最大与和  多对一](https://leetcode.cn/problems/maximum-and-sum-of-array/) | 2392 |
| 3276 | [选择矩阵中单元格的最大得分](https://leetcode.cn/problems/select-cells-in-grid-with-maximum-score/) | 2403 |
| 1595 | [连通两组点的最小成本  带权二分图最小边覆盖](https://leetcode.cn/problems/minimum-cost-to-connect-two-groups-of-points/) | 2538 |
| 3257 | [放三个车的价值之和最大 II](https://leetcode.cn/problems/maximum-value-sum-by-placing-three-rooks-ii/) | 2553 |
| LCP 04 | [覆盖 二分图最大匹配·模板题](https://leetcode.cn/problems/lcp-04/) | — |
| LCP 38 | [守卫城堡 最小割](https://leetcode.cn/problems/lcp-38/) | — |
| 1820 | [最多邀请的个数二分图最大匹配·模板题 🔒](https://leetcode.cn/problems/maximum-number-of-accepted-invitations/) | — |
| 2403 | [杀死所有怪物的最短时间同  题 🔒](https://leetcode.cn/problems/minimum-time-to-kill-all-monsters/) | 3376 |
| 3385 | [破解锁的最少时间 II同  题 🔒](https://leetcode.cn/problems/minimum-time-to-break-locks-ii/) | 3376 |
| 1066 | [校园自行车分配 II一对一，但不是完美匹配 🔒](https://leetcode.cn/problems/campus-bikes-ii/) | — |
| 2123 | [使矩阵中的 1 互不相邻的最小操作数二分图最大独立集 🔒](https://leetcode.cn/problems/minimum-operations-to-remove-adjacent-ones-in-matrix/) | — |
...
| 2493 | [将节点分成尽可能多的组  推荐](https://leetcode.cn/problems/divide-nodes-into-the-maximum-number-of-groups/) | 2415 |
| 1782 | [统计点对的数目](https://leetcode.cn/problems/count-pairs-of-nodes/) | 2457 |
| 3666 | [使二进制字符串全为 1 的最少操作次数  进阶 BFS / Gale-Ryser 定理](https://leetcode.cn/problems/minimum-operations-to-equalize-binary-string/) | 2477 |
| 2612 | [最少翻转操作数  进阶 BFS](https://leetcode.cn/problems/minimum-reverse-operations/) | 2824 |
...
| 2077 | [殊途同归三元环计数 🔒](https://leetcode.cn/problems/paths-in-maze-that-lead-to-same-room/) | — |
| 3656 | [判断是否存在简单图Erdős–Gallai 定理 🔒](https://leetcode.cn/problems/determine-if-a-simple-graph-exists/) | — |
